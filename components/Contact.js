      ...
      <form ref={form} onSubmit={sendEmail} name="contact" className='flex flex-col item-center w-80 md:w-[550px] min-h-screen justify-center mx-auto max-w-xl text-white font-bold text-2xl' method="POST" data-netlify="true">
       ...
       <div className="grid gap-6 mb-6 md:grid-cols-2">
            <div className='relative'>
              ...
              <label htmlFor="first_name" className="absolute text-[16px] duration-300 transform -translate-y-3 scale-75 top-3 z-10 origin-[0] left-2.5 peer-focus:text-[#009897] peer-focus:dark:text-[#009897] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3">First Name</label>
            </div>
            <div className='relative'>
              ...
              <label htmlFor="last_name" className="absolute text-[16px] duration-300 transform -translate-y-3 scale-75 top-3 z-10 origin-[0] left-2.5 peer-focus:text-[#009897] peer-focus:dark:text-[#009897] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3">Last Name</label>
            </div>
            <div className='relative'>
              ...
              <label htmlFor="phone" className="absolute text-[16px] duration-300 transform -translate-y-3 scale-75 top-3 z-10 origin-[0] left-2.5 peer-focus:text-[#009897] peer-focus:dark:text-[#009897] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3">Phone Number</label>
            </div>
            <div className='relative'>
              ...
              <label htmlFor="email" className="absolute text-[16px] duration-300 transform -translate-y-3 scale-75 top-3 z-10 origin-[0] left-2.5 peer-focus:text-[#009897] peer-focus:dark:text-[#009897] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3">Email Address</label>
            </div>
          </div>
