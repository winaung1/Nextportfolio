    ...
    <div className='home min-h-screen pt-10 p-5' id='contact'>
      ...
      <form name="contact" className='flex flex-col item-center min-h-screen justify-center ml-auto mr-auto max-w-xl text-white font-bold text-2xl' method="POST" data-netlify="true">
       ...
       <div class="grid gap-6 mb-6 md:grid-cols-2">
          ...
          <button type="submit" class="text-[#009897] text-2xl bg-transparent border-[3px] border-[#009897] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg w-full sm:w-auto px-5 py-2.5 text-center">Send</button>
      </form>
    </div>
  )
}
